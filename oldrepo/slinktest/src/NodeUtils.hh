...
#define TICKS_PER_USEC 2389.869 // from /proc/cpuinfo on l2pulsar 9/20/2012
//#define TICKS_PER_USEC 3073.305 // from /proc/cpuinfo on l2gpu    9/20/2012
...
inline float delta_time_us(struct timespec ts_s, struct timespec ts_e)
{
    return (ts_e.tv_sec - ts_s.tv_sec) * 1000000 + (ts_e.tv_nsec - ts_s.tv_nsec) * 0.001;
}
