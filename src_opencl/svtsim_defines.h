#ifndef SVTSIM_DEFINES_H
#define SVTSIM_DEFINES_H
...
//#define gf_mask_GPU(x) (gf_mask(x))
...
//  int fep_err[NEVTS][MAXROAD];
 ...
 //output "cable"
  ...
  unsigned long lfitpar[NFITPAR][DIMSPA+1][SVTSIM_NBAR][FITBLOCK];/* full-precision coeffs, P0s */
